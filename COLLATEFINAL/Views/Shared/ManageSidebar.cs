...
namespace  COLLATEFINAL.Views.Shared
{
    /// <summary>
    ...
    public static class ManageSidebar
    {
        ...
        ///     directly from your code. This API may change or be removed in future releases.
        /// </summary>
        public static string GameAndWebDev => "GameAndWebDev";

        /// <summary>
        ///     This API supports the ASP.NET Core Identity default UI infrastructure and is not intended to be used
        ///     directly from your code. This API may change or be removed in future releases.
        /// </summary>
        public static string ResearchPapers => "ResearchPapers";
        ...
        ///     directly from your code. This API may change or be removed in future releases.
        /// </summary>
        public static string PrototypeNavClass(ViewContext viewContext) => SidebarNavClass(viewContext, Prototype);

        /// <summary>
        ///     This API supports the ASP.NET Core Identity default UI infrastructure and is not intended to be used
        ///     directly from your code. This API may change or be removed in future releases.
        /// </summary>
        public static string GameAndWebDevNavClass(ViewContext viewContext) => SidebarNavClass(viewContext, GameAndWebDev);

        /// <summary>
        ///     This API supports the ASP.NET Core Identity default UI infrastructure and is not intended to be used
        ///     directly from your code. This API may change or be removed in future releases.
        /// </summary>
        public static string ResearchPapersNavClass(ViewContext viewContext) => SidebarNavClass(viewContext, ResearchPapers);
