    ...
    public class ExternalLoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetCallbackAsync(string returnUrl = null, string remoteError = null)
        {
            ...
            else
            {
                ...
                string profilePictureUrl = info.Principal.FindFirstValue("picture");
        ...
        public async Task<IActionResult> OnPostConfirmationAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                string profilePictureUrl = info.Principal.FindFirstValue("picture");
                var user = CreateUser();
                user.Id = "external" + "_" + Guid.NewGuid().ToString();
                user.FirstName = Input.FirstName;
                user.LastName = Input.LastName;
                user.ImageUrl = "COLLATE.png";
                ...
                if (result.Succeeded)
                {
                    ...
                    if (result.Succeeded)
                    {
                       ...
                       $"A new user from <strong>Google Account</strong>  has just signed up, Please confirm this account by <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>clicking here to notify the user</a>.");
